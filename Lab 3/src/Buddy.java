...
class Person {
    ...
    int countCommonBuddies(Person that) {
        return this.buddies.countCommonBuddies(that);
    }
...
class ExamplesBuddies {
    ...
    void testCountComBuddies(Tester t) {
        initBuddies();
        t.checkExpect(this.ann.buddies.countCommonBuddies(this.bob), 0);
        t.checkExpect(this.ann.buddies.countCommonBuddies(this.dan), 1);
        t.checkExpect(this.bob.buddies.countCommonBuddies(this.jan), 0);
    }
