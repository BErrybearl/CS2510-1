...
class ExamplesXML {
  ...
  boolean testUpdateAttribute(Tester t) {
    ...
    // Tagged empty = new Tagged(this.ept, new MtLoXMLFrag());

    // Tagged tagged1 = new Tagged(this.tag1, new MtLoXMLFrag());
    // Tagged tagged2 = new Tagged(this.tag2, new ConsLoXMLFrag(this.txt2, new
    // MtLoXMLFrag()));
    // Tagged tagged3 = new Tagged(this.tag3, new ConsLoXMLFrag(this.txt3, new
    // ConsLoXMLFrag(this.txt1, new MtLoXMLFrag())));
    // Tagged tagged4 = new Tagged(this.tag4, new ConsLoXMLFrag(this.txt4, new
    // ConsLoXMLFrag(this.txt2, new MtLoXMLFrag())));
    // Tagged tagged3up = new Tagged(this.tag3up, new ConsLoXMLFrag(this.txt3,
    // new
    // ConsLoXMLFrag(this.txt1, new MtLoXMLFrag())));

    /*
     * IXMLFrag frag1 = this.txt1;
     * 
     * IXMLFrag frag2 = new Tagged(this.tag2, new ConsLoXMLFrag(this.txt2, new
     * MtLoXMLFrag()));
     * 
     * IXMLFrag frag3 = new Tagged(this.tag3, new ConsLoXMLFrag(this.txt3, new
     * ConsLoXMLFrag(this.txt1, new MtLoXMLFrag()))); IXMLFrag frag4 = new
     * Tagged(this.tag4, new ConsLoXMLFrag(this.txt4, new
     * ConsLoXMLFrag(this.txt2, new MtLoXMLFrag()))); IXMLFrag frag3up = new
     * Tagged(this.tag3up, new ConsLoXMLFrag(this.txt3, new
     * ConsLoXMLFrag(this.txt1, new MtLoXMLFrag())));
     */
